...
public abstract class HeadBagDB extends PDRStorageInventoryDB {
    ...
    /**
     * Initialize PostgreSQL database schema for HeadBagDB
     * @param jdbcUrl  the JDBC URL to connect to PostgreSQL database
     * @throws InventoryException if database initialization fails
     */
    public static void initializePostgresDB(String jdbcUrl) throws InventoryException {
        // HeadBagDB uses the same schema as PDRStorageInventoryDB
        PDRStorageInventoryDB.initializePostgresDB(jdbcUrl);
    }
