...
/**
 * a claim on space in a {@link gov.nist.oar.distrib.cachemgr.Cache}.  An instance is normally received 
 * from a request for a particular amount of space via one of the cache's 
 * {@link gov.nist.oar.distrib.cachemgr.Cache#reserveSpace(long)} functions.  Its interface should be used 
