...
/**
 * Unit tests for RPARequestHandlerController using MockMvc.
 * These tests verify the controller behavior with mocked service dependencies.
 */
...
public class RPARequestHandlerControllerTest {
    ...
    @BeforeEach
    public void setup() {
        controller = new RPARequestHandlerController(mockRPAConfiguration, service, mockAsyncExecutor);
