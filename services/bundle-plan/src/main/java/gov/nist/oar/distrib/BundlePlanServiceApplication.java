...
/**
 * Bundle Download Plan Service - creates download plans for data bundles.
 * Extracts functionality from BundleDownloadPlanController.
 */
@SpringBootApplication
@EnableDiscoveryClient
@EnableFeignClients
public class BundlePlanServiceApplication {

    private static Logger logger = LoggerFactory.getLogger(BundlePlanServiceApplication.class);
    ...
    public static void main(String[] args) {
        SpringApplication.run(BundlePlanServiceApplication.class, args);
    }
}
